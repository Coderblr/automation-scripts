...
public class TestProductSorting {
    ...
    public void test_product_sorting() throws Exception {
        // Step 1: navigate
        ...
        FileUtils.copyFile(screenshot, new File("reports/screenshots/TC008_sort_price_low_high.png"));
        ...
        File screenshot = ((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
        FileUtils.copyFile(screenshot, new File("reports/screenshots/TC008_sort_price_high_low.png"));
        ...
        File screenshot = ((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
        FileUtils.copyFile(screenshot, new File("reports/screenshots/TC008_sort_name_z_to_a.png"));
