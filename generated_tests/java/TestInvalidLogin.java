...
public class TestInvalidLogin {
    ...
    public void test_invalid_login() throws Exception {
        ...
        Assert.assertTrue(text7.contains("do not match"), "Expected \"do not match\" but got \"" + text7 + "\"");

        // Step 8: take_screenshot
        File screenshot = ((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
        FileUtils.copyFile(screenshot, new File("reports/screenshots/TC002_invalid_login_error.png"));
