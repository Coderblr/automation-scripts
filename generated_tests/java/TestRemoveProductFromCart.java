 ...
 * Test Case: TC006 - Remove Product from Cart
...
public class TestRemoveProductFromCart {
    ...
    public void test_remove_product_from_cart() throws Exception {
        // Step 1: navigate
        ...
        // Step 13: take_screenshot
        File screenshot = ((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
        FileUtils.copyFile(screenshot, new File("reports/screenshots/TC006_cart_after_remove.png"));
