...
public class TestProductPageVerification {
    ...
    @Test(description = "Product Page Verification")
    public void test_product_page_verification() throws Exception {
        // Step 1: navigate
        ...
        // Step 6: verify_text
        String text6 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.className("product_label"))).getText();
        Assert.assertTrue(text6.contains("Products"), "Expected \"Products\" but got \"" + text6 + "\"");
        ...
        FileUtils.copyFile(screenshot, new File("reports/screenshots/TC004_products_page.png"));
