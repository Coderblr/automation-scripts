...
public class TestCheckoutWithoutInfo {
    ...
    @Test(description = "Checkout Without Info")
    public void test_checkout_without_info() throws Exception {
        // Step 1: navigate
        ...
        // Step 14: verify_text
        String text14 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("h3[data-test=\"error\"]"))).getText();
        Assert.assertTrue(text14.contains("First Name is required"), "Expected \"First Name is required\" but got \"" + text14 + "\"");

        // Step 15: take_screenshot
        File screenshot = ((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
        FileUtils.copyFile(screenshot, new File("reports/screenshots/TC012_checkout_error.png"));
